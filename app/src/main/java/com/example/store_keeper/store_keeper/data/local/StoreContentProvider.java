...
import com.example.store_keeper.store_keeper.data.local.contracts.StoreContract;
...
public class StoreContentProvider extends ContentProvider {
    ...
    private Cursor getItemsWithShortInfo(SQLiteDatabase readableDatabase, String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        if (!TextUtils.isEmpty(selection)) {
            ...
            selectionPairs = SqliteUtility.combineSelectionPairs(
                    selectionPairs,
        ...
        try {
            ...
            switch (sUriMatcher.match(uri)) {
                case ITEM_ATTRS_ID:
                    ...
                    selection = ProductContract.ProductAttribute.COLUMN_ITEM_ID + SqliteUtility.EQUALS + SqliteUtility.PLACEHOLDER;
                ...
                case ITEM_IMAGES_ID:
                    ...
                    //Building the where clause
                    selection = ProductContract.ProductImage.COLUMN_ITEM_ID + SqliteUtility.EQUALS + SqliteUtility.PLACEHOLDER;
                    selectionArgs = new String[]{String.valueOf(ContentUris.parseId(uri))};
                    //Executing delete
                    noOfRecordsDeleted = writableDatabase.delete(
                            ProductContract.ProductImage.TABLE_NAME,
                ...
                case ITEM_ID:
                    ...
                    //Building the where clause
                    selection = ProductContract.Product._ID + SqliteUtility.EQUALS + SqliteUtility.PLACEHOLDER;
                    selectionArgs = new String[]{String.valueOf(ContentUris.parseId(uri))};
                    //Executing delete
                    noOfRecordsDeleted = writableDatabase.delete(
                            ProductContract.Product.TABLE_NAME,
                ...
                case SUPPLIER_ID:
                    ...
                    //Building the where clause
                    selection = SupplierContract.Supplier._ID + SqliteUtility.EQUALS + SqliteUtility.PLACEHOLDER;
                    selectionArgs = new String[]{String.valueOf(ContentUris.parseId(uri))};
                    //Executing delete
                    noOfRecordsDeleted = writableDatabase.delete(
                            SupplierContract.Supplier.TABLE_NAME,
                    ...
                    //identified by the 'supplier_id' passed in the URI
                {
                    ...
                    String selection1 = SupplierContract.SupplierContact.COLUMN_SUPPLIER_ID + SqliteUtility.EQUALS + SqliteUtility.PLACEHOLDER;
                ...
                {
                    //Building the where clause and its Arguments
                    String selection1 = SalesContract.ProductSupplierInfo.COLUMN_SUPPLIER_ID + SqliteUtility.EQUALS + SqliteUtility.PLACEHOLDER;
                    String[] selectionArgs1 = new String[]{String.valueOf(ContentUris.parseId(uri))};
                    //Building a Pair of where clause and its Arguments
                    Pair<String, String[]> selectionPairs = Pair.create(
                            selection1,
                ...
                {
                    //Building the where clause and its Arguments
                    String selection1 = SalesContract.ProductSupplierInfo.COLUMN_ITEM_ID + SqliteUtility.EQUALS + SqliteUtility.PLACEHOLDER;
                    String[] selectionArgs1 = new String[]{String.valueOf(ContentUris.parseId(uri))};
                    //Building a Pair of where clause and its Arguments
                    Pair<String, String[]> selectionPairs = Pair.create(
                            selection1,
                ...
                {
                    //Building the where clause
                    String selection1 = SalesContract.ProductSupplierInventory.COLUMN_ITEM_ID + SqliteUtility.EQUALS + SqliteUtility.PLACEHOLDER;
                    String[] selectionArgs1 = new String[]{String.valueOf(ContentUris.parseId(uri))};
                    //Building a Pair of where clause and its Arguments
                    Pair<String, String[]> selectionPairs = Pair.create(
                            selection1,
                ...
                {
                    //Building the where clause
                    String selection1 = SalesContract.ProductSupplierInventory.COLUMN_SUPPLIER_ID + SqliteUtility.EQUALS + SqliteUtility.PLACEHOLDER;
                    String[] selectionArgs1 = new String[]{String.valueOf(ContentUris.parseId(uri))};
                    //Building a Pair of where clause and its Arguments
                    Pair<String, String[]> selectionPairs = Pair.create(
                            selection1,
